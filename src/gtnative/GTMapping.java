...
public class GTMapping implements GT {
    ...
    public native void gt_feature_node_set_score(Pointer feature_node,
	    float score);
    ...
    public native void gt_feature_node_set_strand(Pointer feature_node,
	    int strand);

    public native int gt_feature_node_get_phase(Pointer feature_node);

    public native void gt_feature_node_set_phase(Pointer feature_node,
	    int strand);
    ...
    public native Pointer gt_feature_node_get_attribute_list(
    ...
    public native int gt_layout_sketch(Pointer gt_lay_ptr,
	    Pointer target_canvas, Pointer err);
    ...
    public native Pointer gt_canvas_cairo_file_new(Pointer style,
	    int output_type, NativeLong width, NativeLong height,
	    Pointer image_info);
    ...
    public native int gt_feature_index_add_gff3file(Pointer fi,
	    String gff3file, Pointer err);
    ...
    /*------------------------------Allocators------------------------------*/
    private native void gt_allocators_init();

    private native void gt_allocators_reg_atexit_func();
