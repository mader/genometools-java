...
public class FeatureNode extends GenomeNode {
    ...
    public FeatureNode(String seqid, String type, int start, int end,
	    String stra) throws GTerrorJava {
	Pointer newfn;
	...
	return (GT.INSTANCE
		.gt_feature_node_has_type(this.genome_node_ptr, type) == 1);
    }
	...
	return GT.INSTANCE.gt_feature_node_get_attribute(this.genome_node_ptr,
		name);
    }
	...
	if (tag.toString() == "" || value.toString() == "") {
	    ...
	    GT.INSTANCE.gt_feature_node_add_attribute(this.genome_node_ptr,
		    tag, value);
	}
    }
