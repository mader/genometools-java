...
abstract class GenomeNode {
	...
	NativeLong nend = GT.INSTANCE
		.gt_genome_node_get_end(this.genome_node_ptr);
    ...
    /*
     * public void accept(Pointer visitor) throws GTerror { GTerror err = new
     * GTerror(); int rval =
     * GT.INSTANCE.gt_genome_node_accept(this.genome_node_ptr, visitor,
     * err.to_ptr()); if (rval != 0) { throw new GTerror(err.get_err(),
     * err.to_ptr()); } }
     */
