...
public class Diagram {
	...
	TRACKSELECTOR tsf = new TRACKSELECTOR() {
	    public void callback(Pointer block_ptr, Pointer str_ptr,
		    Pointer data_ptr) throws GTerrorJava {
		...
		if (s instanceof String) {
		    ...
		    throw new GTerrorJava(
			    "Track selector function must return a string");
		}
	    }
	};
	this.tsf = tsf;
